    ...
    return (
        ...
        className="pt-40 p-10">
            ...
            <div className="flex flex-col gap-4 w-2/3">
                ...
                <p className="text-lg">Since 1995, NASA's Astronomy Picture of the day (APOD) has been showcasing breathtaking images of space, from distant galaxies to celestial events visible from Earth. Eacg day, a new image is selected by professional astronomers to capture the ebauty and mystery of our universe.</p>
                <Link to='/todays-pod'>
